...
const PUBLIC_KEYS = ["exchange_rate", "usdt_rate", "business_name", "whatsapp", "whatsapp_david", "whatsapp_david_name", "whatsapp_brian", "whatsapp_brian_name", "instagram"] as const
