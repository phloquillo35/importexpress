...
<button
          ...
          <div className="mt-3">
            <ShareButton
              variant="full"
              title={`Mirá esto: ${product.name}`}
              menuAlign="left"
              className="[&>button]:w-full sm:[&>button]:w-auto [&>button]:px-8 [&>button]:py-3.5 [&>button]:bg-muted [&>button]:hover:bg-muted/70 [&>button]:rounded-full [&>button]:justify-center"
            />
          </div>
