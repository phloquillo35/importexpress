...
import { Package, ArrowLeft, ShoppingBag, ShieldCheck, Truck, AlertCircle, Plus, X, Share2, Link2, MessageCircle, Send } from "lucide-react"
...
const shareText = `Mirá esto: ${product.name}`
...
<button
          ...
          <div className="relative mt-3" ref={shareMenuRef}>
            <button
              onClick={() => setShowShareMenu(v => !v)}
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-muted hover:bg-muted/70 text-foreground font-medium rounded-full transition-colors w-full sm:w-auto justify-center"
            >
            ...
            {showShareMenu && (
              <div className="absolute z-20 mt-2 w-64 bg-card border border-border/60 rounded-2xl shadow-xl p-2 left-0">
