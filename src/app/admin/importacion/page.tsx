...
const statusConfig: Record<string, { label: string; className: string; dot: string; textColor: string }> = {
  ...
  in_transit: { label: "En tránsito", className: "bg-blue-500/10 text-blue-400", dot: "bg-blue-400", textColor: "text-blue-400" },
  received: { label: "Recibido", className: "bg-[#22C55E]/10 text-[#22C55E]", dot: "bg-[#22C55E]", textColor: "text-[#22C55E]" },
  cancelled: { label: "Cancelado", className: "bg-red-500/10 text-red-400", dot: "bg-red-400", textColor: "text-red-400" },
}
